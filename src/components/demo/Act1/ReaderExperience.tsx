      ...
      <div className="relative" style={{ perspective: "1200px" }}>
        <div
          ...
          style={{
            ...
            boxShadow:
              "20px 20px 60px rgba(0,0,0,0.6), -2px -2px 10px rgba(255,255,255,0.03)",
          }}
        >
          ...
          <div className="p-6 md:p-8">
            ...
            {/* QR Trigger Card — THIS MUST CALL onQRClick */}
            <motion.button
              type="button"
              className="mt-6 w-full text-left border border-[rgba(0,229,204,0.25)] rounded-lg p-4 cursor-pointer group"
...
function AITwinChat() {
  ...
  const conversation =
    selectedPath !== null ? aiTwinConversations[selectedPath] : null;
...
export function ReaderExperience() {
  // CRITICAL: showChat starts as FALSE — chat is hidden until QR is clicked
  ...
  return (
    <section className="py-24 relative">
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-20">
        {/* Scene 1: The Book with QR trigger */}
        <div className="space-y-8">
          ...
          <FadeReveal className="text-center max-w-xl mx-auto" delay={0.3}>
            <p className="text-[#666] text-sm">
              Every chapter contains intelligent triggers — QR codes, SMS
              prompts, and URLs that turn passive readers into active
              participants.
            </p>
          </FadeReveal>
        </div>

        {/* Scene 2: AI Twin Chat — ONLY appears after QR click */}
        <AnimatePresence>
          {showChat && (
            <motion.div
            ...
            >
              <div className="text-center">
                ...
                <p className="text-[#666] text-sm mt-2">
                  It answers questions, qualifies interest, and routes hot
                  prospects to the sales team — 24/7.
                </p>
              </div>
              <AITwinChat />
            </motion.div>
        ...
        {/* Hint text — only shows when chat is hidden */}
        {!showChat && (
          <FadeReveal className="text-center">
            <p className="text-[#666] text-sm">
