...
// ─── HOW IT WORKS (Compressed 3-column) ──────────────────────────
  ...
  const items = [
    {
      ...
      description: "Six 90-minute sessions. Nine hours. No writing. We extract your methodology and build the book.",
    },
    {
      title: "Intellibook Technology",
      description: "QR triggers, SMS capture, and trackable CTAs embedded in every format — physical, digital, audio.",
    },
    {
      title: "AI SDR Twin",
      description: "Trained on your voice and offer. Engages readers, qualifies intent, books calls. Always on.",
    },
    {
      title: "CoreText Analytics",
      description: "Chapter-level engagement, CTA performance, conversation outcomes, revenue attribution.",
    },
    {
      title: "Fulfillment + Distribution",
      description: "Print, digital, audio, Amazon — handled end to end. No vendor coordination on your side.",
    },
    {
      title: "Selective Onboarding",
      description: "One expert brand per month. Application-based. We only take clients where we can forecast ROI.",
    },
  ];
    ...
    <section className="py-24 px-6">
      ...
      <FadeReveal delay={0.3} className="text-center mt-8 max-w-xl mx-auto">
        <p className="text-[#666] text-sm">
          ...
          If you&apos;re on the right, we&apos;ll tell you that on the first call —
          we don&apos;t take clients we can&apos;t deliver for.
        </p>
      </FadeReveal>
    </section>
  );
      ...
      <FadeReveal>
        <div className="max-w-2xl mx-auto text-center bg-[#111] border border-[rgba(0,229,204,0.15)] rounded-2xl p-10 md:p-14 relative overflow-hidden">
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse, #00E5CC, transparent 70%)",
            }}
          />
...
export function ProductPage() {
  return (
    <div className="bg-[#0A0A0A] min-h-screen">
      ...
      {/* Math section with calculator link */}
      <section className="py-16 px-6 text-center">
        <FadeReveal>
          ...
          <p className="text-[#666] mt-4 mb-8 max-w-md mx-auto">
            Input your ad spend, close rate, and program price.
            See exactly what your client acquisition cost becomes.
          </p>
          <motion.a
