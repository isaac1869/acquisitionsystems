          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-[#666] flex items-center gap-2">
                <span className="text-[#FF4444]">✕</span> Leads are cold — no relationship
              </p>
              <p className="text-[#666] flex items-center gap-2">
                <span className="text-[#FF4444]">✕</span> Pipeline dies when spend stops
              </p>
              <p className="text-[#666] flex items-center gap-2">
                <span className="text-[#FF4444]">✕</span> Zero attribution to close
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-[#999] flex items-center gap-2">
                <span className="text-[#00E5CC]">✓</span> Buyers who paid, read, and trust you
              </p>
              <p className="text-[#999] flex items-center gap-2">
                <span className="text-[#00E5CC]">✓</span> Books keep working forever
              </p>
              <p className="text-[#999] flex items-center gap-2">
                <span className="text-[#00E5CC]">✓</span> Full 1:1 attribution via CoreText
              </p>
            </div>
          </div>
        </div>
...
function Row({
  ...
  return (
    <div className={`flex justify-between items-center ${large ? "" : ""}`}>
      <span className={`text-sm ${large ? "text-[#999] font-medium" : "text-[#666]"}`}>
        {label}
      </span>
      {children || (
      ...
      <div className="bg-[#111] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
            ...
            <LineChart data={compoundingChartData}>
              ...
              <Tooltip
                ...
                formatter={(value?: number, name?: string) => [
                  value != null ? `$${value.toLocaleString()}K` : "",
              ...
              <Legend
                formatter={(value: string) => (
                  <span style={{ color: "#999", fontSize: "12px" }}>
                    {value === "traditional" ? "Traditional Model" : "Intellibook Model"}
                  </span>
                )}
              />
              <Line
        ...
        <FadeReveal delay={0.3} className="mt-6 text-center">
          <p className="text-[#999] text-sm">
            ...
            budget funds new readers. The library compounds.
          </p>
        </FadeReveal>
      </div>
    </FadeReveal>
    ...
    <FadeReveal className="mt-24 text-center">
      ...
      >
        <h3 className="text-2xl md:text-4xl font-semibold text-[#F5F5F5] leading-tight">
          One expert. One book.
          <br />
          <span className="text-[#00E5CC]">Negative acquisition cost.</span>
          <br />
