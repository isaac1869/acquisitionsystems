...
function ActivityFeed() {
  ...
  return (
    <div ref={ref} className="bg-[#111] border border-[rgba(255,255,255,0.06)] rounded-xl overflow-hidden h-full">
          ...
          {events.map((event) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className={`${event.isHighlight ? "text-[#F5F5F5] font-medium" : "text-[#999]"} truncate`}>
                  {event.message}
                </p>
...
function FunnelVisualization() {
  return (
    <div className="bg-[#111] border border-[rgba(255,255,255,0.06)] rounded-xl p-4">
      <p className="text-[#F5F5F5] text-sm font-medium mb-4">Conversion Funnel</p>
      <div className="space-y-3">
          ...
          >
            <div className="flex justify-between text-xs mb-1">
              ...
              <span className="font-mono text-[#F5F5F5]">
                {stage.value.toLocaleString()} <span className="text-[#666]">({stage.pct}%)</span>
              </span>
            </div>
            <div className="h-2 bg-[#1a1a1a] rounded-full overflow-hidden">
              <motion.div
                ...
                style={{
                  background: i === funnelStages.length - 1
                    ? "#FFB800"
          ...
          {attributionNodes.map((node, i) => (
            ...
            >
              ...
              <motion.div
                ...
                animate={
                  node.type === "close"
                    ? { boxShadow: ["0 0 8px rgba(255,184,0,0.3)", "0 0 20px rgba(255,184,0,0.6)", "0 0 8px rgba(255,184,0,0.3)"] }
                    : {}
                }
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <FadeReveal delay={0.3} className="text-center mt-8">
          <p className="text-[#999] text-sm">
            ...
            which client — and what path they took to get there.
          </p>
        </FadeReveal>
